...
try {
    ...
    if ($member_result->num_rows === 0) {
        ...
        $debug_info = [
            ...
            'query_result_count' => $debug_result ? $debug_result->num_rows : 'query_failed',
            'query' => $debug_query
        ];
        throw new Exception('Không tìm thấy thông tin thành viên hội đồng. Debug: ' . json_encode($debug_info, JSON_UNESCAPED_UNICODE));
    }
    ...
    $update_member->bind_param("dssssss", 
        $total_score, 
        $overall_comment, 
